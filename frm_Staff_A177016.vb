Public Class frm_Staff_A177016
    Private Sub frm_Staff_A177016_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Refresh_Grid()
    ...
    Private Sub frm_Staff_A177016_Closed(sender As Object, e As EventArgs) Handles Me.Closed
