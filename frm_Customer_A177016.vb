Public Class frm_Customer_A177016
    Private Sub frm_Customer_A177016_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub grd_Customer_MouseHover(sender As Object, e As EventArgs) Handles grd_Customer.MouseHover
        drop_panel.Size = drop_panel.MinimumSize
        drop_panel2.Size = drop_panel2.MinimumSize
        drop_panel3.Size = drop_panel3.MinimumSize
    End Sub

    Private Sub frm_Customer_A177016_Closed(sender As Object, e As EventArgs) Handles Me.Closed
